      ...
      <div className="info-section1">
        <div className="online-payment">
          <div className="online-payment-div1">
            ...
            <p className="information-col1-p2">Banka gəlmədən və növbələrdə vaxt <br /> itirmədən kartınızla 4 addıma kredit <br /> borcunuzun ödənişi.</p>
          </div>
        ...
        <div className="hr-opportunities">
          <div className="hr-opportunities-div1">
            ...
            <p className="information-col2-p2">Kapital Bankın peşəkarlar komandasına <br /> qoşulmaq istəyirsinizsə, Sizi müvafiq <br /> vakansiyaya müraciət etməyə dəvət edirik. <br /> Biz sizə dinamik mühitdə maraqlı və <br /> perspektivli iş təklif edirik.</p>
          </div>
